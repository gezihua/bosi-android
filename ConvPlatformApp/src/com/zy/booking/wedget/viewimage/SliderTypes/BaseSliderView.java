package com.zy.booking.wedget.viewimage.SliderTypes;
 ...
 * and
 * {@link com.example.androidimageslider.wedget.viewimage.SliderTypes.daimajia.slider.library.SliderTypes.TextSliderView}
...
public abstract class BaseSliderView {
	...
	protected void loadImage(final ImageView targetImageView) {
		...
		CpApplication.getApplication().mBitmapManager.disPlayWithListener(
				targetImageView, mUrl, new BitmapLoadCallBack<View>() {
