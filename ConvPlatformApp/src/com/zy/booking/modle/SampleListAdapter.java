...
public class SampleListAdapter extends ComListViewAdapter<JsonArray> {

	BitmapUtils mBitmapUtils;
	BitmapDisplayConfig mConfig;

	public SampleListAdapter(Context mContext, JsonArray mData) {
		super(mContext, mData);
		initBitmapUtils(mContext);
		
	}
	
	private void initBitmapUtils(Context mContext){
